...
public class Pending extends Fragment {
    ...
    Query pendingRef;
    ArrayList<ScheduleAServiceDP> pendingList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pendingRef= FirebaseDatabase.getInstance().getReference("ServiceOrders").orderByChild("orderStatus").equalTo("pending");
        pendingList=new ArrayList<>();
        rvPending.setLayoutManager(new GridLayoutManager(getActivity(),1));
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getDataForPendingOrders();

    }

    private void getDataForPendingOrders() {
        progressDialog.show();
        pendingRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1:snapshot.getChildren())
                {
                    ...
                    pendingList.add(scheduleAServiceDP);
                }
                Collections.reverse(pendingList);
                OrdersAdapter adapter=new OrdersAdapter(getActivity(),pendingList);
